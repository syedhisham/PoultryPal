    ...
    <header className="flex justify-between items-center p-4 text-white shadow-md">
      ...
      >
        <Tooltip title={greeting} arrow>
          <div className="text-white ml-2">{greetingIcon}</div>
        </Tooltip>
        <Box className="ml-4">
          <Typography
            variant="h6"
            className="font-bold text-white animate__animated animate__fadeInLeft"
          >
            {greeting}, {name}
          </Typography>
          <Typography
            variant="body2"
            className="text-gray-300 animate__animated animate__fadeInLeft"
          >
